...
export default class TraceablePeerConnection {
    ...
    */
     ...
     * @returns
     */
    getLocalVideoSSRCs(localTrack: any): any[];
    /**
     ...
     * @returns {RTCSessionDescription} the munged description.
     */
    _updateAv1DdHeaders(description: RTCSessionDescription): RTCSessionDescription;
    /**
     ...
     */
    isVideoCodecDisabled(codec: any): boolean;
    /**
     ...
     * @returns {void}
     */
    setVideoCodecs(codecList: any): void;
    /**
     ...
     */
    _setMaxBitrates(description: RTCSessionDescription, isLocalSdp?: boolean): RTCSessionDescription;
    /**
     ...
     * @returns {Promise} promise that will be resolved when the operation is successful and rejected otherwise.
     */
    _updateVideoSenderEncodings(frameHeight: number, localVideoTrack: any): Promise<any>;
    /**
