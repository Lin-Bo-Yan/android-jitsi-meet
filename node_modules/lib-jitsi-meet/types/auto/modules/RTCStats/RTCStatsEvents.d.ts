 ...
 */
export declare enum RTCStatsEvents {
    /**
...
export declare const RTC_STATS_WC_DISCONNECTED = RTCStatsEvents.RTC_STATS_WC_DISCONNECTED;
export declare const RTC_STATS_PC_EVENT = RTCStatsEvents.RTC_STATS_PC_EVENT;
