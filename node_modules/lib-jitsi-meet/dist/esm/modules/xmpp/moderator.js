...
export default class Moderator extends Listenable {
    ...
    sendConferenceRequest(roomJid) {
        ...
        return new Promise(resolve => {
            if (this.mode === 'xmpp') {
                ...
                this.connection.sendIQ(this._createConferenceIq(roomJid), result => this._handleIqSuccess(roomJid, result, resolve), error => this._handleIqError(roomJid, error, resolve));
    ...
    authenticate(roomJid) {
        return new Promise((resolve, reject) => {
            this.connection.sendIQ(this._createConferenceIq(roomJid), result => {
