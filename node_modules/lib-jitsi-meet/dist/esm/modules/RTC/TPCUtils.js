    ...
    */
            ...
            if (newHeight > 0) {
                if (localVideoTrack.getVideoType() === VideoType.CAMERA) {
                    active = frameHeight <= newHeight
                        ...
                        // simulcast streams.
                        || ((_a = videoStreamEncodings[idx]) === null || _a === void 0 ? void 0 : _a.scaleResolutionDownBy) === LD_SCALE_FACTOR;
                }
                else {
    ...
    updateEncodingsResolution(localVideoTrack, parameters) {
        ...
        if (allEqualEncodings(parameters.encodings)) {
            const videoStreamEncodings = this._getVideoStreamEncodings(localVideoTrack.getVideoType(), this.pc.getConfiguredVideoCodec());
