...
function connectionFilter(config) {
    var _a, _b, _c;
    for (const iceUrl of (_c = (_b = ((_a = config === null || config === void 0 ? void 0 : config.iceServers) !== null && _a !== void 0 ? _a : [])[0]) === null || _b === void 0 ? void 0 : _b.urls) !== null && _c !== void 0 ? _c : []) {
...
class RTCStats {
     ...
     */
    init(initConfig) {
        const { analytics: { rtcstatsUseLegacy: useLegacy = false, rtcstatsPollInterval: pollInterval = 10000, rtcstatsSendSdp: sendSdp = false, rtcstatsEnabled = false } = {} } = initConfig;
        ...
        if (!rtcstatsEnabled || this._initialized)
            return;
        rtcstatsInit({ statsEntry: this.sendStatsEntry.bind(this) }, { connectionFilter,
            pollInterval,
            useLegacy,
            sendSdp,
    ...
    reset() {
        var _a;
        (_a = this._trace) === null || _a === void 0 ? void 0 : _a.close();
        this._trace = null;
    }
    /**
